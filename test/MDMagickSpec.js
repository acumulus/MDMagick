describe("MDMagick", function () {
    ...
    describe("MDM Loading", function () {
        it("automatic mdm-input elements should have mdm-buttons div", function () {
            expect($("#section-2 .mdm-buttons").length).toEqual(1);
        });

        it("automatic mdm-input elements should have mdm-preview div", function () {
            expect($("#section-2 .mdm-preview").length).toEqual(1);
        });

        it("non automatic mdm-input elements should not have mdm-buttons div", function () {
            expect($("#section-1 .mdm-buttons").length).toEqual(0);
            expect($("#section-3 .mdm-buttons").length).toEqual(0);
        });

        it("non automatic mdm-input elements should not have mdm-previw div", function () {
    ...
    describe("showdown", function () {
        it("should create a list", function () {
            ...
            var html = new Attacklab.showdown.converter().makeHtml(text);
