...
function MDM(inputElement) {
    ...
    this.activateControls = function (controlsElement) {
        var _self = this;
        ["bold", "italic", "underline", "strikethru", "link", "heading", "list", "numlist"].forEach(function (actionName) {
    ...
    controlsTemplate: function () {
        var template =
            "<div class=\"mdm-buttons mdm-control\">" +
                ...
                "    <li class=\"mdm-underline\"><a class=\"mdm-icon-underline\" href=\"#mdm-underline\"><span>U</span></a></li>" +
                "    <li class=\"mdm-strikethru\"><a class=\"mdm-icon-strikethru\" href=\"#mdm-strikethru\"><span>S</span></a></li>" +
                "    <li class=\"mdm-separator\"><span>|</span></li>" +
                ...
                "    <li class=\"mdm-numlist\"><a class=\"mdm-icon-ordered\" href=\"#mdm-numlist\"><span>#</span></a></li>" +
                "    <li class=\"mdm-separator\"><span>|</span></li>" +
                "    <li class=\"mdm-heading\"><a class=\"mdm-icon-heading\" href=\"#mdm-heading\"><span>H</span></a></li>" +
                "  </ul>" +
                "</div>";
